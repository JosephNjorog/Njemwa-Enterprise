...
<html>
<head>
	<title>NE - Sales And Inventory Management System</title>
...
<script src="<?php echo base_url('assets/js/jquery-NE.js') ?>"></script>
<script src="<?php echo base_url('assets/js/print.js') ?>"></script>
<script src="<?php echo base_url('assets/js/NE.js') ?>"></script>
</body>
</html>